...
class StudentsProvider extends ChangeNotifier {
  ...
  Future<void> addStudent(String firstName, String gender, String lastName) async {
    await _repository.addStudent(firstName: firstName, gender: gender, lastName: lastName);
