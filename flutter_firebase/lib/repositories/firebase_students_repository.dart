...
class FirebaseStudentsRepository extends StudentRepository  {
  static const String baseUrl = 'https://week08-stuent-firebase-default-rtdb.asia-southeast1.firebasedatabase.app/Students';
  static const String studentCollection = "student";
  static const String stuUrl = '$baseUrl/$studentCollection.json';

  @override
  Future<Student> addStudent({required String firstName, required String gender, required String lastName, required double score}) async {
    Uri uri = Uri.parse(stuUrl);
    final newStudentData = {'firstName': firstName, 'gender': gender, 'lastName': lastName , 'score': score};
    ...
    return Student(id: newId, firstName: firstName, gender: gender, lastName: lastName, score: 0.0);
  }
